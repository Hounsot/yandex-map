...
let map = null;
        ...
        async function main() {
            ...
            // Define coordinates 55.497733, 37.429007
            const CENTER_COORDINATES = [37.429007, 55.497733];
            const MARKER_COORDINATES = [37.429007, 55.497733];
            const LOCATION = {
    ...
    },
    {
        ...
        "stylers": {
            ...
            markerElement.innerHTML = '<img id="MapMarker" style="height:63.97px; width: 54px;" src="https://optim.tildacdn.com/tild3930-3465-4630-a237-633132623337/-/resize/216x/-/format/webp/Q_KuvekinoMarker.png" alt="">';
